...
export function Contact() {
  return (
    <section
      id="contato"
      className="section bg-terracotta-500 text-sand-50"
    >
      <Container size="narrow" className="text-center">
        ...
        <h2 className="mt-6 font-display text-4xl leading-[1.05] tracking-tightest text-sand-50 md:text-5xl lg:text-6xl">
          Pronta para cuidar da sua pele com
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-sand-100/85 md:text-lg">
          Marque sua avaliação pelo WhatsApp. Respondo pessoalmente para
          entender o seu momento e te orientar sobre o melhor caminho.
        </p>
